...
func TestVersionIsNoneForLegacyMarkers(t *testing.T) {
	ini := "; rpie automatically added this to enable the phpredis/phpredis extension\n" +
		"; priority=20\nextension=redis\n"
...
func TestParsesZendExtensionBlock(t *testing.T) {
	ini := "; rpie automatically added this to enable the xdebug/xdebug extension\n" +
...
func TestDefaultsPriorityWhenAbsent(t *testing.T) {
	ini := "; rpie automatically added this to enable the vendor/ext extension\nextension=ext\n"
	parsed := parseMarkers(ini, "x.ini")
	if len(parsed) != 1 {
		t.Fatalf("want 1 result, got %d", len(parsed))
	}
...
func TestRemovesOnlyTheTargetedBlock(t *testing.T) {
	ini := "; hand written\nextension=gd\n" +
		"\n; rpie automatically added this to enable the phpredis/phpredis extension\n" +
		"; priority=20\n; version=6.1.0\nextension=redis\n" +
		"\n; rpie automatically added this to enable the xdebug/xdebug extension\n" +
		"; priority=95\n; version=3.4.0\nzend_extension=xdebug\n"
...
func TestRemovalOfAbsentExtensionIsNoop(t *testing.T) {
	ini := "; rpie automatically added this to enable the vendor/foo extension\nextension=foo\n"
